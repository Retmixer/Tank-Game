(() => {
 ...
 let busy=false,selected='desert',pending=0;
 ...
 function open(){if(busy)return;select($('mapSelect').value||selected);$('setupMode').value=$('modeSelect').value||'solo';$('garage').inert=true;$('battleSetup').hidden=false;$('setupBack').focus();}
